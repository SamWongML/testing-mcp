 ...
 * layout. Because {@link ArtifactStore} has no `list`, resolving a run from its id
 ...
 * stateless: nothing is remembered in memory between requests.
 *
...
export interface PersistedRun {
  ...
  traceKey: string;
  /** A fetchable location reference for the trace (file:// locally, s3:// ). */
  traceUri: string;
}
